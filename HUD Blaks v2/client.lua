...
Citizen.CreateThread(function()
	while ESX == nil do
		TriggerEvent('::{ImLew}::esx:getSharedObject', function(obj) ESX = obj end)
		Citizen.Wait(0)
	end
...
RegisterNetEvent('::{ImLew}::esx:playerLoaded')
AddEventHandler('::{ImLew}::esx:playerLoaded', function(xPlayer)
	local cash, dirtycash, bank = 0, 0, 0
...
RegisterNetEvent('::{ImLew}::esx:setJob')
AddEventHandler('::{ImLew}::esx:setJob', function(job)
	SendNUIMessage({
		action = 'setInfos',
		infos = {
			{
...
RegisterNetEvent('::{ImLew}::esx:setJob2')
AddEventHandler('::{ImLew}::esx:setJob2', function(job2)
	SendNUIMessage({
		action = 'setInfos',
		infos = {
			{
...
RegisterNetEvent('::{ImLew}::esx:setAccountMoney')
AddEventHandler('::{ImLew}::esx:setAccountMoney', function(account)
